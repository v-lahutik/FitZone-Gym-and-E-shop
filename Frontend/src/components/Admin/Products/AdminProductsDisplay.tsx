    ...
    <div className="p-4 min-h-screen">
      ...
      <div className="mb-4 flex gap-4 flex-wrap">
        ...
        <button
          ...
          className="bg-primary text-white px-4 py-2 rounded hover:bg-red-700 transition transform duration-300"
        >
          Add New Product
        </button>
      </div>
            ...
            >
              ...
              <div className="mt-4 px-5 pb-5">
                <div className="flex justify-end">
                  <span
                    className={`rounded-full px-2 py-1 text-center text-sm font-medium ${badgeStyle}`}
                  >
                    {badgeText}
                  </span>
                </div>
                ...
                <div className="flex gap-1">
                  <button
                    ...
                    className="w-1/2 flex items-center justify-center rounded-md bg-blackColor3 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary transition transform duration-300 focus:outline-none focus:ring-4 focus:ring-blue-300"
                  >
                    Edit
                  </button>
                  <button
