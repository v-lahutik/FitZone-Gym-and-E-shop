...
export const handleUpdateUser = async (localMember: Member, closeForm: ()=>void) => {
  if (localMember) {
...
export const handleRegisterUser = async (localMember: Member, closeForm: ()=>void) => {
  if (localMember) {
...
export const handleDeleteUser = async (localMember: Member, closeForm: ()=>void) => {
  if (localMember) {
